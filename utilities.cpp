...
// Returns true if the gridPoint p lies inside the polygon[] with n vertices 
bool isInside(gridPoint* polygon, int n, gridPoint p) 
{ 
    // There must be at least 3 vertices in polygon[] 
    if (n < 3)  return false; 
  
    // Create a gridPoint for line segment from p to infinite 
    gridPoint extreme = gridPoint(INF, p.y, 0); 
    ...
    { 
        ...
        { 
            // If the gridPoint 'p' is colinear with line segment 'i-next', 
